...
description: 'Three mechanisms key on what a consumer declares itself to be, and nothing defines where a consumer declares it. consumers on a Bundle, starters and requires on a luma/catalog all narrow by consumer kind or tag.'
...
# A repository cannot say what kind of consumer it is, so nothing keys on it
...
see [[work-items/LEAD-0001-a-third-kind-of-consumer-for-a-bundle-installed-across-everything-you-work-on]], **which assumes this field works and is
...
- More later, but that is the whole vocabulary today. See
  [[work-items/LEAD-0001-a-third-kind-of-consumer-for-a-bundle-installed-across-everything-you-work-on]].
...
[[work-items/LEAD-0001-a-third-kind-of-consumer-for-a-bundle-installed-across-everything-you-work-on]] outright. It is also what would let a catalog rather
...
somebody went looking. See [[work-items/LEAD-0009-nothing-carries-what-a-project-learned-back-up-to-hq]].

## Related work

- Born from the idea it replaces: [`a-repository-cannot-say-what-kind-it-is`](../../ideas/a-repository-cannot-say-what-kind-it-is.md)
