...
description: 'Should bundle preload get more sophisticated? Today it is one unconditional value. Three shapes it could take instead: "These are ideas, maybe bad maybe great.".'
...
# Should preload become more sophisticated — a when, a hook, or an event
...
[[work-items/LEAD-0013-a-mandate-is-a-record-not-a-value-who-mandated-it-since-when-and-when-it-applies]], which reaches the same problem from the
...
- Born from the idea it replaces: [`conditional-preload`](../../ideas/conditional-preload.md)
