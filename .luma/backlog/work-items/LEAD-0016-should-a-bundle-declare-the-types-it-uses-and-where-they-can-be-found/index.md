...
description: 'I wonder if bundle.md should list what types this bundle expects to use and where they can be found. And this would not load the types up front. It would just make them easy to find when the bundle needs them.'
...
# Should a bundle declare the types it uses, and where they can be found
...
for.
[[work-items/LEAD-0007-a-luma-backlog-bundle-and-whether-its-types-belong-there-or-in-luma-types]] — the same question one level down: which bundle a
...
- Born from the idea it replaces: [`bundle-declares-the-types-it-uses`](../../ideas/bundle-declares-the-types-it-uses.md)
