...
description: '.luma/bundles/routing.toml is generated from every adopted Bundle and is not a Bundle. It sits in bundles/ because there is nowhere else.'
...
# Committed derived material has no tier, and the cache deferral asked the wrong question
...
[[work-items/LEAD-0009-nothing-carries-what-a-project-learned-back-up-to-hq]].

## Related work

- Born from the idea it replaces: [`committed-derived-material-has-no-tier`](../../ideas/committed-derived-material-has-no-tier.md)
