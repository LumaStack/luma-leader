...
description: 'Catalog and bundle resolution should possibly support precludes: — which says that when loading this bundle, another bundle cannot be loaded. They will break each other, this is known, and we are letting you know.'
...
# A bundle may declare that another bundle cannot be loaded beside it
...
- Born from the idea it replaces: [`precludes`](../../ideas/precludes.md)
