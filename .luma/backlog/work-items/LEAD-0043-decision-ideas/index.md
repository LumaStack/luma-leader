...
type_version: "0.0.2"
key: LEAD-0043
title: 'Decision ideas'
description: 'Settled positions and the reasoning that settled them. Recorded so they are not re-argued from scratch. A path not taken is recorded as deferred with a re-open trigger, never as rejected.'
...
- Born from the idea it replaces: [`decision-ideas`](../../ideas/decision-ideas.md)
