...
description: 'A finding rather than a proposal. Surfaced three times during the session that shipped the second convention, and never written down until asked for. Written out in full — what the knowledge format''s §10.4 recommends and what luma-catalog shipped.'
...
# Two type-namespacing conventions exist and neither knows about the other
...
- Born from the idea it replaces: [`two-namespacing-conventions`](../../ideas/two-namespacing-conventions.md)
