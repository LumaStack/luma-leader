...
description: 'Rethinking the luma-prefixed bundles — what do we actually need? What we have so far is not well thought out and will need to be reworked. It is all experimental so far. See luma-catalog/catalog/bundles for the current set.'
...
**This design is a bet that [[work-items/LEAD-0032-bundle-dependencies]] eventually lands**, and it
...
- [[work-items/LEAD-0032-bundle-dependencies]] — the mechanism the layering assumes.
...
- [[work-items/LEAD-0010-a-repository-cannot-say-what-kind-of-consumer-it-is-so-nothing-keys-on-it]] — why that blocker is still open.

## Related work

- Born from the idea it replaces: [`rethinking-the-luma-prefixed-bundles`](../../ideas/rethinking-the-luma-prefixed-bundles.md)
