...
description: 'A harness ships two or three working modes and you cannot add a fourth. Plan, edit-allowed, auto — one vendor''s division of how work is done, offered as the whole vocabulary.'
...
# Work modes — named postures a session holds, and something that holds it there
...
works.** [[work-items/LEAD-0044-design-first-working-mode]] records that a session may be explicitly
...
- **Prose alone.** Free, portable, and demonstrably insufficient — it is what
  [[work-items/LEAD-0044-design-first-working-mode]] already relies on.
- **Hooks that block.** A hook firing before a tool call can refuse the write
  ...
  [[work-items/LEAD-0039-loading-mechanisms]] already works through what hooks cost — code on
...
- **Does a mode change what knowledge loads?** Brainstorm mode arguably wants
  *less* project context in front of it, which inverts everything
  [[work-items/LEAD-0040-how-knowledge-arrives]] is built to do.
...
- Born from the idea it replaces: [`work-modes`](../../ideas/work-modes.md)
