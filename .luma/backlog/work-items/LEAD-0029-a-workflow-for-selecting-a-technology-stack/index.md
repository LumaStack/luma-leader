...
description: 'I want a workflow for selecting technology stack for a new project in my organization.'
...
- Born from the idea it replaces: [`technology-stack-selection`](../../ideas/technology-stack-selection.md)
