...
description: 'Rename deliverable to issue or story or something similar, because that is really what they are. Quite often an issue is broken down into a deliverable — but not always.'
...
- Born from the idea it replaces: [`rename-deliverable-to-issue-or-story`](../../ideas/rename-deliverable-to-issue-or-story.md)
