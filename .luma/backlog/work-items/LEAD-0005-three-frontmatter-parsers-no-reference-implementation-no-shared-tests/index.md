...
description: 'A finding. Raised as two; there are three, and they differ in kind rather than merely in implementation. None is a reference implementation, and no test tells any of them they disagree.'
...
# Three frontmatter parsers, no reference implementation, no shared tests
...
[[work-items/LEAD-0006-two-type-namespacing-conventions-exist-and-neither-knows-about-the-other]] — same root cause, same window. Two conventions
...
- Born from the idea it replaces: [`three-frontmatter-parsers`](../../ideas/three-frontmatter-parsers.md)
