...
description: 'Twelve bundles ship templates and nothing says how to write one. They are the most-copied artifact in the estate and the least specified: no contract, no conventions, no statement of what a template is for.'
...
# A bundle-template-maker bundle — what a bundle template is, and what stops it rotting
...
**The estate already has another kind.** [[work-items/LEAD-0028-templates-for-organization-personas]] proposes
...
[[work-items/LEAD-0016-should-a-bundle-declare-the-types-it-uses-and-where-they-can-be-found]] is the same question from the bundle's
side.
...
- Born from the idea it replaces: [`bundle-template-maker`](../../ideas/bundle-template-maker.md)
