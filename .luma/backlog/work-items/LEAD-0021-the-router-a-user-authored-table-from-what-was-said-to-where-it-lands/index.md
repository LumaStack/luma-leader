...
description: 'When a person says I have an idea, something should already know where ideas go. Which organization, which project, which bundle or tool — decided once, by the person, ahead of time, instead of re-decided by an agent every session.'
...
# The router — a user-authored table from what was said to where it lands
...
**Utterances, not work.** [[work-items/LEAD-0039-loading-mechanisms]] and [[work-items/LEAD-0040-how-knowledge-arrives]]
...
on guesses needs the same honesty [[work-items/LEAD-0039-loading-mechanisms]] demands of knowledge
...
- **Whether bundles declare routable intents.** A bundle saying "I accept
  ...
  free-hand authorship — which rhymes with what [[work-items/LEAD-0015-should-preload-become-more-sophisticated-a-when-a-hook-or-an-event]] wants
...
- Born from the idea it replaces: [`router`](../../ideas/router.md)
