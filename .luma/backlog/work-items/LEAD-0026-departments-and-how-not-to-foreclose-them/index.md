...
description: 'Draft — not settled, not reviewed. Recorded so the options survive, not to pick one. Some organizations have departments, and nothing here decides what that means.'
...
- Born from the idea it replaces: [`departments`](../../ideas/departments.md)
