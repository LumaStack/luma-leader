...
description: 'Like video game design, every tool should teach you how to use it as you go — the beginning level. Which means: Below the idea and separate from it, so the raw version survives a reading that may turn out to be wrong.'
...
# Every tool teaches you to use it as you go, like a game's first level
...
[[work-items/LEAD-0015-should-preload-become-more-sophisticated-a-when-a-hook-or-an-event]], not a curriculum it has already finished.
...
[[work-items/LEAD-0001-a-third-kind-of-consumer-for-a-bundle-installed-across-everything-you-work-on]]** and it should be settled the same cheap way here:
...
[[work-items/LEAD-0015-should-preload-become-more-sophisticated-a-when-a-hook-or-an-event]] — the always-present index, which is what serves the
agent where a curriculum serves the human.
[[work-items/LEAD-0001-a-third-kind-of-consumer-for-a-bundle-installed-across-everything-you-work-on]] — per-person scope, and the machine-versus-person
...
- Born from the idea it replaces: [`every-tool-teaches-you-to-use-it`](../../ideas/every-tool-teaches-you-to-use-it.md)
