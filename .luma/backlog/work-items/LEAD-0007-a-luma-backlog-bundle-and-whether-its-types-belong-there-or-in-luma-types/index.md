...
description: 'At some point we should create a luma-catalog/backlog bundle, and decide whether the backlog types belong in that bundle or in the luma-types bundle. The point of the bundle is so agents know how to use the tool, and how to use the types.'
...
# A luma/backlog bundle, and whether its types belong there or in luma-types
...
`stage: unknown`. Its README also says *"no implementation yet"*
...
[[work-items/LEAD-0004-deliverable-is-probably-wrong-reopen-the-naming]] — the unit names, unresolved, and
cheaper to change before a catalog bundle publishes them.

## Related work

- Born from the idea it replaces: [`where-backlog-types-live`](../../ideas/where-backlog-types-live.md)
