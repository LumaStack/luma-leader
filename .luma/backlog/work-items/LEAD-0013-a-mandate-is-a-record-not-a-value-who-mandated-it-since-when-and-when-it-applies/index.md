...
description: 'Mandating a bundle load is complicated, and sometimes the context of the situation will matter. "I don''t know, this is an idea. Maybe it''s bad." And the constraint behind it. Loading all mandates would be nice if context were unlimited.'
...
# A mandate is a record, not a value — who mandated it, since when, and when it applies
...
**Related, reached from the other direction:** [[work-items/LEAD-0015-should-preload-become-more-sophisticated-a-when-a-hook-or-an-event]] asks the
...
- Born from the idea it replaces: [`a-mandate-is-a-record-not-a-value`](../../ideas/a-mandate-is-a-record-not-a-value.md)
