...
description: 'consumers on a bundle is project or organization today. It should also cover the case where something is installed across everything you work on — global, personal, machine, whatever that turns out to be called.'
...
# A third kind of consumer, for a bundle installed across everything you work on
...
- Born from the idea it replaces: [`a-third-kind-of-consumer`](../../ideas/a-third-kind-of-consumer.md)
