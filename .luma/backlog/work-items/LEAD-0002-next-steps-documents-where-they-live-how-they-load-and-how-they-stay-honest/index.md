...
description: 'Next-steps documents should be a real thing with rules, not a file somebody invents each time.'
...
# Next-steps documents — where they live, how they load, and how they stay honest
...
**Nothing existing covers it.** `stage` is maturity —
...
- Born from the idea it replaces: [`next-steps-documents`](../../ideas/next-steps-documents.md)
