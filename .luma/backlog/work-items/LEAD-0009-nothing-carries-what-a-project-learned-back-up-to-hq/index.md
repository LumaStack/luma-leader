...
description: 'The estate has a direction and it works. hq settles a standard, foreman makes it executable, changes flow one way. the-estate says so and luma-foreman''s own README repeats it: hq settles, foreman ships.'
...
# Nothing carries what a project learned back up to hq
...
- Born from the idea it replaces: [`no-channel-for-what-a-project-learns`](../../ideas/no-channel-for-what-a-project-learns.md)
