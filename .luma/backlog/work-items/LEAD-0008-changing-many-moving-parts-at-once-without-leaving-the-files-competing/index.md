...
description: 'When making big changes that touch many files — code, config, policies, workflows, and/or docs — we need to design a process for changing many moving parts in a way that doesn''t leave files competing with each other.'
...
# Changing many moving parts at once, without leaving the files competing
...
- Born from the idea it replaces: [`changing-many-moving-parts-at-once`](../../ideas/changing-many-moving-parts-at-once.md)
