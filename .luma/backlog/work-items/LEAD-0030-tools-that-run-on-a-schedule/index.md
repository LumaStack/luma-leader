...
description: 'Or better yet the foreman or hq sweeper should run every day/week and look up what happens on a schedule and make sure we''re doing it.'
...
- Born from the idea it replaces: [`tools-that-run-on-a-schedule`](../../ideas/tools-that-run-on-a-schedule.md)
