...
<!-- luma-foreman:generated from lumastack/luma-catalog/git-worktrees procedure/repair-worktrees. Regenerate with `luma-foreman apply`; edits are lost. -->

# Repair worktrees

**Read `.luma/bundles/lumastack/luma-catalog/git-worktrees/procedure/repair-worktrees.md` and follow it.** That file is the procedure. This is the adapter that makes it reachable from here, and it deliberately carries no copy of it — the copy would drift.
